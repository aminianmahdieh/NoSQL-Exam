...
**USE CASE:** *Get the geolocation of a city (by default it is London) from an Api and with this location from another Api get the weathe forcast of 5 days in advance of that city; send this forcast data through producer to the consumer and consumer produces some silly messages based on each day weather.* 
...
In order to be able to run these files you should have the following requirments. 
